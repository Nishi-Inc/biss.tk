...
<%--&lt;%&ndash; Create new game popup &ndash;%&gt;--%>
    ...
    <%--<div class="modal-body">--%>
        <%--<form id="create-new-game-form" class="ajax form-horizontal" method="post" action="#" role="form" >--%>
            ...
            <%--&lt;%&ndash;<div class="control-group">&ndash;%&gt;--%>
                <%--&lt;%&ndash;<label for="number-of-properties" class="control-label">Total properties:</label>&ndash;%&gt;--%>
                <%--&lt;%&ndash;<div class="">&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<input type="text" id="number-of-properties" name="game.numberOfPrperties" class="form-control" placeholder="Not more than 5" title="Number of players to play at a time. Not more than 5."&ndash;%&gt;--%>
                           <%--&lt;%&ndash;value="4" pattern="[2-5]" maxlength="1" required>&ndash;%&gt;--%>
                <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
            <%--&lt;%&ndash;</div>&ndash;%&gt;--%>
...
<%--&lt;%&ndash; Ask question modal popup &ndash;%&gt;--%>
